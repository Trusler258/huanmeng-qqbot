...
_EXTRA_DESC = {
    ...
    "积分": "查看积分余额",
    # 游戏
    "wzq": "五子棋对战（人机/双人，支持网页下棋与悔棋）",
    "五子棋": "五子棋对战（人机/双人，支持网页下棋与悔棋）",
    "xq": "中国象棋对战（四档难度，支持网页下棋）",
    "象棋": "中国象棋对战（四档难度，支持网页下棋）",
    "go": "围棋对战（9/13/19 路可选，难度新手→专家，支持网页下棋）",
    "围棋": "围棋对战（9/13/19 路可选，难度新手→专家，支持网页下棋）",
    "luck": "每日运势抽签",
    "dice": "掷骰子得积分",
    "gh": "公会登记管理",
    "pgr": "Phigros 谱面查询",
    ...
    # 赞赏
    "reward": "赞赏码与赞助名单（`仅发图` 只回图片；add 记录赞助）",
    "赞赏": "赞赏码与赞助名单（`仅发图` 只回图片；add 记录赞助）",
    "赞助": "赞赏码与赞助名单（`仅发图` 只回图片；add 记录赞助）",
    "sponsor": "赞赏码与赞助名单（`仅发图` 只回图片；add 记录赞助）",
    # 插件
